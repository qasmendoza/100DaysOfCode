...
"""
height = float(input("Enter the height in Meters: ")) # Added "Enter the height in Meters: " for clarity
weight = float(input("Enter the weight in Kilograms: ")) # Added "Enter the weight in Kilograms: " for clarity
